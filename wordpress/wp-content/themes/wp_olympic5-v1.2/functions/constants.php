...
if(!defined('CI_THEME_NAME')) 		define('CI_THEME_NAME', 'olympic');
...
if(!defined('CI_THEME_NICENAME')) 	define('CI_THEME_NICENAME', 'Olympic');
...
if(!defined('CI_FORUM'))			define('CI_FORUM', 'http://www.cssigniter.com/support/viewforum.php?f=65');
