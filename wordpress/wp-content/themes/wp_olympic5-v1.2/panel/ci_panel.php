...
function ci_register_theme_default_scripts() {
	...
	wp_register_script( 'jquery-fitVids', get_child_or_parent_file_uri( '/panel/scripts/jquery.fitvids.js' ), array( 'jquery' ), '1.1', false );
	...
	wp_register_style( 'font-awesome', get_child_or_parent_file_uri( '/panel/components/fontawesome/css/font-awesome.css' ), array(), '4.3.0' );
						...
						<div id="ci_options_inner">
							<?php
								...
								foreach($paneltabs as $name => $title) {
									...
									?><div id="tab<?php echo $tabNum; ?>" class="tab <?php echo $firstclass ?>"><?php get_template_part( CI_PANEL_TABS_DIR . '/' . $name ); ?></div><?php
									$tabNum ++;
								}
							?>
						</div>
